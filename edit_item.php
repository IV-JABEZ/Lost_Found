...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES['item_image']['name'])) {
        ...
        $image = time() . '_' . $_FILES['item_image']['name'];
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="date" name="date_found" value="<?= $row['date_found'] ?>">
                ...
                <!-- CLAIM STATUS -->
                <select name="status">
                    <option value="Unclaimed" <?= $row['status']=="Unclaimed"?"selected":"" ?>>Unclaimed</option>
